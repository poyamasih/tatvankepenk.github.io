...
-- Function to check if a column exists - IMPORTANT: parameter order matches Dart code
...
-- Function to add a column if it doesn't exist - IMPORTANT: parameter order matches Dart code
